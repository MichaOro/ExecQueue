---
name: pytest-task
description: Expand or repair the ExecQueue pytest suite with focused coverage that matches the repository's current bootstrap stage.
---
...
2. Keep tests near the current repository scope: smoke tests, API checks, and focused behavior tests.
...
- Is the test scope proportional to the current code maturity?
