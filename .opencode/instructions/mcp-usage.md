...
- The postgres MCP is denied globally. Only `db-inspector` may use it without approval for read-oriented inspection, and only `db-writer` may use it with approval prompts.
